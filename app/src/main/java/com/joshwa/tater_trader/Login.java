...
public class Login extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button mLoginButton = (Button) findViewById(R.id.bLogin);
...
//    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        {
            JSONResponse response = ServerProxy.getInstance().authenticate(new User("", "", mEmail, mPassword));
            mLoginResponse = response.getMessage();
